...
<head>
    ...
    <!--[if lt IE 9]>
      ...
      <script src="https://oss.maxcdn.com/libs/respond.frontend/js/1.4.2/respond.min.js"></script>
    <![endif]-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="frontend/images/logo.png" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="frontend/about.html">About Us</a></li>
                        <li class="dropdown">
